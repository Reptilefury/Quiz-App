...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //load data
        queList.add(new QuestionClass(" Who is the Ueab church chaplin?", "Kesis", "Prof Mayaka Muheshimiwa",
                "Wahonya", "Mugeke", "Kesis"));
        queList.add(new QuestionClass("Do you like going to church?", "Yes", "No",
                "I don't  care", " I don't know where church is", " Yes"));
        queList.add(new QuestionClass("Will you graduate this year?", "Yes", "No",
                "Tulia msee umekuja sana", "Hiyo ni story ingine", "Yes"));
        //init conter
        conter = 0;
